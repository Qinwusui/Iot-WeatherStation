...
void initWeather()
{
    ...
    https.addHeader("Accept",
                    "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,v=b3;q=0.9");

    https.addHeader("Accept-Encoding", "application/json");
    https.addHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36");
    ...
    if (https.begin(*client, url))
    {
        ...
        {
            Serial.println("连接失败" + String(code));
