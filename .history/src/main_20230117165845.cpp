...
void setup()
{
    ...
    tWeatherUpdateTask.waitForDelayed(tWifiConnectTask.getInternalStatusRequest(), TASK_SECOND, -1);
    tWeatherDisplayTask.waitForDelayed(tWeatherUpdateTask.getInternalStatusRequest(), TASK_IMMEDIATE, -1);
...
void ttimeUpdate() // 1s更新一次
{
    ...
    if (!timeClient.update())
    {
        ...
        tTimeUpdateTask.restartDelayed(60 * 1000);
    }
...
void initWeather()
{
    ...
    if (wa.code != "200")
    {
        ...
        tWeatherUpdateTask.restartDelayed(5000);
    }
}
